        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="space-y-6 animate-fade-in">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              We believe travel planning should be exciting, not exhausting. Our diverse team brings together 
              expertise in business development, technology, and design to create a platform that makes 
              discovering and planning your perfect trip effortless and enjoyable.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
              From our studies at Monash University to our combined experience in startups across Australia, 
              Indonesia, and Thailand, we understand the challenges travelers face and are passionate about 
              solving them.
            </p>
          </div>
        </div>
