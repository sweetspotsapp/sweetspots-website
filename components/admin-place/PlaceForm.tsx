...
//       description: "",
//       priceRange: "$",
//       latitude: defaultValues?.latitude ?? -37.8136, // Melbourne default
...
//     (v: string) => setValue("vibes", vibes.filter((x) => x !== v), { shouldDirty: true }),
//     [vibes, setValue]
//   );
...
//                         // Keep map centered when lat/lng changes
//                         map.setView([lat ?? -37.8136, lng ?? 144.9631]);
//                       }}
//                     >
//                       <TileLayer
...
//                       <MapClicker onPick={handlePickLocation} />
//                     </MapContainer>
//                   )}
//                 </div>
//               </div>
//               <p className="text-sm text-muted-foreground">
//                 Click anywhere on the map to set latitude & longitude. Then use "Use Map Location" to auto-fill the address from OpenStreetMap.
//               </p>
//             </div>
